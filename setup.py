...
setup(
    ...
    entry_points={
        'console_scripts': [
            ...
            'ocrd-segment-extract-textline=ocrd_segment.cli:ocrd_segment_extract_textline',
            'ocrd-segment-extract-region-COCO=ocrd_segment.cli:ocrd_segment_extract_region_COCO'
        ]
    },
)
